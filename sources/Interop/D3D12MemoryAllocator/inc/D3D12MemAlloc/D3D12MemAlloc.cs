...
namespace TerraFX.Interop
{
    public static unsafe partial class D3D12MemoryAllocator
    {
        ...
        /// </summary>
        [return: NativeTypeName("HRESULT")]
        public static partial int CreateVirtualBlock([NativeTypeName("const VIRTUAL_BLOCK_DESC*")] D3D12MA_VIRTUAL_BLOCK_DESC* pDesc, D3D12MA_VirtualBlock** ppVirtualBlock);
    }
}
