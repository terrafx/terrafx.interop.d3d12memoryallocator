...
namespace TerraFX.Interop
{
        ...
        where T : unmanaged
    {
        ...
        public D3D12MA_List(D3D12MA_ALLOCATION_CALLBACKS* allocationCallbacks)
        {
...
#pragma warning restore CS0660, CS0661
        {
            ...
            public iterator(D3D12MA_List<T>* pList, Item* pItem)
            {
                m_pList = pList;
                m_pItem = pItem;
            }
        ...
        public iterator begin() => new iterator((D3D12MA_List<T>*)Unsafe.AsPointer(ref this), Front());

        public iterator end() => new iterator((D3D12MA_List<T>*)Unsafe.AsPointer(ref this), null);
        ...
        public iterator insert(iterator it, T* value) => new iterator((D3D12MA_List<T>*)Unsafe.AsPointer(ref this), InsertBefore(it.m_pItem, value));
    }
}
