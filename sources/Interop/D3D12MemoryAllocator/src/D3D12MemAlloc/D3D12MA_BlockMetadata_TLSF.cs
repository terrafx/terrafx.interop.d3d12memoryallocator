...
internal unsafe partial struct D3D12MA_BlockMetadata_TLSF : D3D12MA_BlockMetadata.Interface
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_BlockMetadata_TLSF*, bool>)(Base.lpVtbl[2]))((D3D12MA_BlockMetadata_TLSF*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_BlockMetadata_TLSF*, bool>)(Base.lpVtbl[7]))((D3D12MA_BlockMetadata_TLSF*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_BlockMetadata_TLSF*, ulong, ulong, bool, uint, D3D12MA_AllocationRequest*, bool>)(Base.lpVtbl[9]))((D3D12MA_BlockMetadata_TLSF*)Unsafe.AsPointer(ref this), allocSize, allocAlignment, upperAddress, strategy, pAllocationRequest);
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<D3D12MA_BlockMetadata_TLSF*, void>)(Base.lpVtbl[21]))((D3D12MA_BlockMetadata_TLSF*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
