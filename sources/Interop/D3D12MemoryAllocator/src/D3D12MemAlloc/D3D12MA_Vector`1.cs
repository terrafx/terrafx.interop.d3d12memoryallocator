...
namespace TerraFX.Interop
{
        ...
        where T : unmanaged
    {
        ...
        public D3D12MA_Vector(D3D12MA_ALLOCATION_CALLBACKS* allocationCallbacks)
        {
        ...
        public D3D12MA_Vector([NativeTypeName("size_t")] nuint count, D3D12MA_ALLOCATION_CALLBACKS* allocationCallbacks)
        {
            m_AllocationCallbacks = allocationCallbacks;
        ...
        public D3D12MA_Vector(in D3D12MA_Vector<T> src)
        {
        ...
        public static void Copy(in D3D12MA_Vector<T> rhs, ref D3D12MA_Vector<T> lhs)
        {
