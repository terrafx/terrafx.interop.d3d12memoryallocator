...
internal unsafe partial struct D3D12MA_BlockMetadata_Linear : D3D12MA_BlockMetadata.Interface
{
    ...
    public void Dispose()
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, void>)(Base.lpVtbl[0]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this));
    }

    [VtblIndex(1)]
    public void Init([NativeTypeName("UINT64")] ulong size)
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, void>)(Base.lpVtbl[1]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this), size);
    }

    [VtblIndex(2)]
    public readonly bool Validate()
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, byte>)(Base.lpVtbl[2]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this))) != 0;
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, nuint>)(Base.lpVtbl[3]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, nuint>)(Base.lpVtbl[4]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong>)(Base.lpVtbl[5]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, ulong>)(Base.lpVtbl[6]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), allocHandle);
    }

    [VtblIndex(7)]
    public readonly bool IsEmpty()
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, byte>)(Base.lpVtbl[7]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this))) != 0;
    }
    ...
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, D3D12MA_VIRTUAL_ALLOCATION_INFO*, void>)(Base.lpVtbl[8]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), allocHandle, outInfo);
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, ulong, byte, uint, D3D12MA_AllocationRequest*, byte>)(Base.lpVtbl[9]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this), allocSize, allocAlignment, (byte)(upperAddress ? 1 : 0), strategy, pAllocationRequest) != 0;
    }
    ...
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, D3D12MA_AllocationRequest*, ulong, void*, void>)(Base.lpVtbl[10]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this), request, allocSize, PrivateData);
    }

    [VtblIndex(11)]
    public void Free([NativeTypeName("D3D12MA::AllocHandle")] ulong allocHandle)
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, void>)(Base.lpVtbl[11]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this), allocHandle);
    }

    [VtblIndex(12)]
    public void Clear()
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, void>)(Base.lpVtbl[12]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong>)(Base.lpVtbl[13]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)));
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, ulong>)(Base.lpVtbl[14]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), prevAlloc);
    }
    ...
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, ulong>)(Base.lpVtbl[15]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), alloc);
    }

    [VtblIndex(16)]
    public readonly void* GetAllocationPrivateData([NativeTypeName("D3D12MA::AllocHandle")] ulong allocHandle)
    {
        return ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, void*>)(Base.lpVtbl[16]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), allocHandle);
    }

    [VtblIndex(17)]
    public void SetAllocationPrivateData([NativeTypeName("D3D12MA::AllocHandle")] ulong allocHandle, void* privateData)
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, ulong, void*, void>)(Base.lpVtbl[17]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref this), allocHandle, privateData);
    }

    [VtblIndex(18)]
    public readonly void AddStatistics([NativeTypeName("D3D12MA::Statistics &")] D3D12MA_Statistics* inoutStats)
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, D3D12MA_Statistics*, void>)(Base.lpVtbl[18]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), inoutStats);
    }
    ...
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, D3D12MA_DetailedStatistics*, void>)(Base.lpVtbl[19]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), inoutStats);
    }

    [VtblIndex(20)]
    public readonly void WriteAllocationInfoToJson([NativeTypeName("D3D12MA::JsonWriter &")] D3D12MA_JsonWriter* json)
    {
        ((delegate* unmanaged<D3D12MA_BlockMetadata_Linear*, D3D12MA_JsonWriter*, void>)(Base.lpVtbl[20]))((D3D12MA_BlockMetadata_Linear*)Unsafe.AsPointer(ref Unsafe.AsRef(in this)), json);
    }
