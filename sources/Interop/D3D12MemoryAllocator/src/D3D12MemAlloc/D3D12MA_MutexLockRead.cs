...
/// <summary>Helper RAII class to lock a RW mutex in constructor and unlock it in destructor (at the end of scope), for reading.</summary>
internal readonly unsafe partial struct D3D12MA_MutexLockRead : IDisposable
{
