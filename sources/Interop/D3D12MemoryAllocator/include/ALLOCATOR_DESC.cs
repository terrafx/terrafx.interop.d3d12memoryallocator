...
{
    /// <summary>Parameters of created <see cref="Allocator"/> object. To be used with <see cref="D3D12MemoryAllocator.CreateAllocator"/>.</summary>
    public unsafe struct ALLOCATOR_DESC
    {
        ...
        /// <para><see cref="Allocator"/> is doing <see cref="IUnknown.AddRef"/>/<see cref="IUnknown.Release"/> on this object.</para>
        /// </summary>
