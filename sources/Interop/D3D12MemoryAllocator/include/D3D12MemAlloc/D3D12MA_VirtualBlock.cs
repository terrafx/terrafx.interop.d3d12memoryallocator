...
public unsafe partial struct D3D12MA_VirtualBlock : D3D12MA_IUnknownImpl.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_VirtualBlock*, Guid*, void**, int>)(Base.lpVtbl[0]))((D3D12MA_VirtualBlock*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_VirtualBlock*, uint>)(Base.lpVtbl[1]))((D3D12MA_VirtualBlock*)Unsafe.AsPointer(ref this));
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged[MemberFunction]<D3D12MA_VirtualBlock*, uint>)(Base.lpVtbl[2]))((D3D12MA_VirtualBlock*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<D3D12MA_VirtualBlock*, void>)(Base.lpVtbl[3]))((D3D12MA_VirtualBlock*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        ((delegate* unmanaged[MemberFunction]<D3D12MA_VirtualBlock*, void>)(Base.lpVtbl[4]))((D3D12MA_VirtualBlock*)Unsafe.AsPointer(ref this));
    }
