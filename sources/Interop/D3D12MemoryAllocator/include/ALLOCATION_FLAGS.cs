...
{
    /// <summary>Bit flags to be used with <see cref="ALLOCATION_DESC.Flags"/>.</summary>
    [Flags]
    public enum ALLOCATION_FLAGS
    {
        ...
        /// <para>You should not use <see cref="ALLOCATION_FLAG_COMMITTED"/> and <see cref="ALLOCATION_FLAG_NEVER_ALLOCATE"/> at the same time. It makes no sense.</para>
        /// </summary>
